  ...
  return (
    <div>
      ...
      <div className='lg:hidden bg-home-link-background-blue text-white uppercase flex flex-col pl-8 pt-7 pr-8 justify-between' >
        ...
        <a href="https://api.whatsapp.com/send?phone=5581988145903&text=Ol%C3%A1!%20Queria%20saber%20mais%20sobre%20os%20servi%C3%A7os%20de%20Automa%C3%A7%C3%A3o%20Residencialwa.link/dj993i" target="__blank" className=' inline-block border border-solid rounded-xl border-white max-w-44 ml-3 p-1 m-4 mb-6 font-bold text-center hover:bg-white hover:text-home-link-background-blue hover:transition-colors duration-300'>
          Fale Conosco
        </a>
      </div>
